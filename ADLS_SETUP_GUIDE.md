...
- Container: dairy-data-platform-data
...
ADLS_CONTAINER=dairy-data-platform-data
...
#### General Setup
For other CI/CD platforms, ensure your pipeline has access to:
- `ADLS_ACCOUNT_KEY`: Your Azure storage account key

Set this as an environment variable or secret in your CI/CD system.
